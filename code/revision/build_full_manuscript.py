...
P("Reviewer comment on the original asked that the deviation of the linear osmotic "
  ...
  "consumption from 12.64 to 12.87 kWh m-3, evaluated deterministically at the "
...
P("The earlier version of this analysis treated non-energy operating cost as a share "
  ...
  "configuration is carbon negative. The comparator itself requires definition: the $0.76 m-3 "
...
P("Two conditions bound the result, and both are stated rather than assumed. "
  ...
  "architecture is %+.2f kg m-3. Route D is therefore a "
